...
export default function AddFunds() {
    ...
    useEffect(() => {
        document.title = 'Adicionar Fundos';
    ...
    const submit = async (e) => {
        ...
        setLoading(true);
        try {
            // const res = await axios.post('/wallets', {
    ...
    return (
        <Grid container spacing={1} justifyContent={'center'}>
            ...
            <ConfirmationDialog
                ...
                message={`Tem certeza que deseja adicionar ${parseFloat(amount).toPrecision(4)} ${selectedCurrency.currencyCode} (${selectedCurrency.name}) para ${user?.name}?`}
